        ...
        case 'tab_content': {
            ...
            const tabPrompts = {
                basicLearn: '이 교안의 "기본 학습" 영역을 작성하세요. 개요, 학습 목표, 핵심 내용(개념 정의, 이론 설명, 예시, 사례 분석)만 포함합니다. 실습, 평가, 강사 가이드는 다른 탭에서 작성하므로 여기서는 절대 포함하지 마세요. 초보자도 이해할 수 있는 수준으로 설명하세요.\n' +
                    '[시간 배분 — 이 탭: 90~120분]\n' +
                    '이 탭은 전체 480분(8시간) 과정 중 기본학습 90~120분에 해당합니다.\n' +
                ...
                basicPrac: '이 교안의 "기본 실습" 영역을 작성하세요. 학생이 핵심 내용을 직접 체험하는 실습 과제를 설계하세요.\n' +
                    '[시간 배분 — 이 탭: 90~120분]\n' +
                    '이 탭은 전체 480분(8시간) 과정 중 기본실습 90~120분에 해당합니다.\n' +
                    '각 ## 섹션의 ⏱️ 예상 소요 시간을 명시하고, 합계가 90~120분이 되게 하세요.\n\n' +
                    '[분량 규칙 — 절대 준수]\n' +
                ...
                advLearn: '이 교안의 "심화 학습" 영역을 작성하세요. 기본 학습의 개념을 더 깊이 파고들어 고급 이론, 업계 사례, 실무적 분석을 제공하세요. 실습, 평가, 강사 가이드는 다른 탭에서 작성하므로 여기서는 절대 포함하지 마세요.\n' +
                    '[시간 배분 — 이 탭: 90~120분]\n' +
                    '이 탭은 전체 480분(8시간) 과정 중 심화학습 90~120분에 해당합니다.\n' +
                    '각 ## 섹션의 ⏱️ 예상 소요 시간을 명시하고, 합계가 90~120분이 되게 하세요.\n\n' +
                    '[분량 규칙 — 절대 준수]\n' +
                    '- 순수 텍스트(마크다운 서식 제외) 최소 12,000자 이상.\n' +
                    '- 마크다운 줄 수 기준 최소 350줄 이상.\n' +
                ...
                advPrac: '이 교안의 "심화 실습" 영역을 작성하세요. 도전적이고 창의적인 프로젝트형 과제를 설계하세요.\n' +
                    '[시간 배분 — 이 탭: 90~120분]\n' +
                    '이 탭은 전체 480분(8시간) 과정 중 심화실습 90~120분에 해당합니다.\n' +
                    '각 ## 섹션의 ⏱️ 예상 소요 시간을 명시하고, 합계가 90~120분이 되게 하세요.\n\n' +
                    '[분량 규칙 — 절대 준수]\n' +
                    '- 순수 텍스트(마크다운 서식 제외) 최소 8,000자 이상.\n' +
                    '- 마크다운 줄 수 기준 최소 250줄 이상.\n' +
                ...
                assessment: '이 교안의 "학습 이해도 점검" 영역을 작성하세요.\n' +
                    '[시간 배분 — 이 탭: 30~60분]\n' +
                    '이 탭은 전체 480분(8시간) 과정 중 학습이해도 점검 30~60분에 해당합니다.\n\n' +
                    '[형식 규칙 — 반드시 준수]\n' +
